package com.keven.mvcframework.v2.servlet;

import com.keven.mvcframework.annotation.*;
...
public class KevenDispatcherServletBak extends HttpServlet{
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        for (int i = 0; i < parameterTypes.length; i ++) {
            ...
            if(parameterType == HttpServletRequest.class){
                ...
                KevenRequestParam requestParam = (KevenRequestParam)parameterType.getAnnotation(KevenRequestParam.class);
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if(!clazz.isAnnotationPresent(KevenController.class)){continue;}

            //保存写在类上面的@KevenRequestMapping("/demo")
            String baseUrl = "";
            ...
            for (Method method : clazz.getMethods()) {
                if(!method.isAnnotationPresent(KevenRequestMapping.class)){continue;}
    ...
    private void doAutowired() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            for (Field field : fields) {
                if(!field.isAnnotationPresent(KevenAutowired.class)){continue;}
    ...
    private void doScanner(String scanPackage) {
        //scanPackage = com.keven.demo ，存储的是包路径
    ...
    private void doLoadConfig(String contextConfigLocation) {
        ...
        //相对于scanPackage=com.keven.demo 从文件中保存到了内存中
